...
import { nodeToAstroComponent } from './util/nodeListToAstroComponents';
...
function defaultInline(type: string, node: Inline): any {
  return (
...
export interface NodeRenderer {
  (node: Block | Inline, children: any): any;
}
...
/**
 * Serialize a Contentful Rich Text `document` to Astro tree
 */
export function documentToAstroComponents(
  ...
  return nodeToAstroComponent(richTextDocument, {
    renderNode: {
